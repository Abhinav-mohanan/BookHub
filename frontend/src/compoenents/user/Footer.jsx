        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm text-gray-400">
              Your digital library for borrowing and exploring thousands of books online.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="/user/dashboard" className="hover:text-blue-400 transition">Browse Books</a></li>
              <li><a href="/user/dashboard" className="hover:text-blue-400 transition">Categories</a></li>
